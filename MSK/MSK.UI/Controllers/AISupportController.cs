...
namespace MSK.UI.Controllers
{
    ...
    public class AISupportController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            chatLayoutDtos = chatLayoutDtos.OrderByDescending(c => c.CreationTime).ToList();
            var groupedChat = chatLayoutDtos.GroupBy(c => c.CreationTime).ToList();
            return View(groupedChat);
        }
        [HttpPost]
