...
namespace MSK.Data.Migrations
{
    ...
    [Migration("20240221185655_MapModelUpdated")]
    partial class MapModelUpdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSK.Core.Models.Candidate", b =>
                {
                    ...
                    b.Property<double>("VotedPercent")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("MSK.Core.Models.Map", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("InfoMainEnd")
                        .IsRequired()
                        .HasMaxLength(5000)
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("InfoMainMiddle")
                        .IsRequired()
                        .HasMaxLength(5000)
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("InfoMainStart")
                        .IsRequired()
                        .HasMaxLength(5000)
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MSK.Core.Models.Vote", b =>
                {
                    ...
                    b.Property<string>("VoterFinCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MSK.Core.Models.Voter", b =>
                {
                    b.HasBaseType("Microsoft.AspNetCore.Identity.IdentityUser");
            ...
            modelBuilder.Entity("MSK.Core.Models.CalendarPlan", b =>
                {
                    b.HasOne("MSK.Core.Models.Election", "Election")
                        .WithOne("CalendarPlan")
                        .HasForeignKey("MSK.Core.Models.CalendarPlan", "ElectionId")
            ...
            modelBuilder.Entity("MSK.Core.Models.Decision", b =>
                {
                    b.HasOne("MSK.Core.Models.Election", "Election")
                        .WithOne("Decision")
                        .HasForeignKey("MSK.Core.Models.Decision", "ElectionId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("MSK.Core.Models.Instruction", b =>
                {
                    b.HasOne("MSK.Core.Models.Election", "Election")
                        .WithOne("Instruction")
                        .HasForeignKey("MSK.Core.Models.Instruction", "ElectionId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("MSK.Core.Models.Vote", b =>
                {
                    b.HasOne("MSK.Core.Models.Candidate", "Candidate")
                        .WithMany("Votes")
